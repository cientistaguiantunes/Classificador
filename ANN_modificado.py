...
def Model_ANN(i):
    ...
    trainX, trainY, testX, testY = import_csv()

    # ------------------ iniciei o comentário ------------------
    ...
    testX = np_utils.to_categorical(testX.shape)
    testY = np_utils.to_categorical(testY.shape)
    # ------------------------------ Finalizei o comentário ---------------------------
